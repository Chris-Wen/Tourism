<?php
 ...
 //7:查询总页数
 $sql = "SELECT count(*) FROM qh_address_list WHERE address_uid=$uid";
 //echo $sql;
 ...
 //8:查询当前页内容
 $sql = "SELECT address_id,address_uname,phone,address";
 $sql .= " FROM qh_address_list  WHERE address_uid=$uid LIMIT $start,$count";
